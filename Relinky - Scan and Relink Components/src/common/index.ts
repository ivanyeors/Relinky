...
export type ScanType = 'inactive-tokens' | 'missing-library' | 'deleted-variables' | 'linked-library' |
...
export interface PluginMessage {
  ...
  sourceType?: 'raw-values' | 'missing-library' | 'deleted-variables' | 'linked-library'; // Source type for scan-for-tokens message
}
