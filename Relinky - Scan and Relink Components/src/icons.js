...
const otherIcon = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="Section 1">
<path d="M-217 -182C-217 -183.105 -216.105 -184 -215 -184H186C187.105 -184 188 -183.105 188 -182V43C188 44.1046 187.105 45 186 45H-215C-216.105 45 -217 44.1046 -217 43V-182Z" fill="#444444"/>
<path d="M-215 -183H186V-185H-215V-183ZM187 -182V43H189V-182H187ZM186 44H-215V46H186V44ZM-216 43V-182H-218V43H-216ZM-215 44C-215.552 44 -216 43.5523 -216 43H-218C-218 44.6568 -216.657 46 -215 46V44ZM187 43C187 43.5523 186.552 44 186 44V46C187.657 46 189 44.6568 189 43H187ZM186 -183C186.552 -183 187 -182.552 187 -182H189C189 -183.657 187.657 -185 186 -185V-183ZM-215 -185C-216.657 -185 -218 -183.657 -218 -182H-216C-216 -182.552 -215.552 -183 -215 -183V-185Z" fill="white" fill-opacity="0.1"/>
<g id="others">
<rect id="Rectangle 5" x="3.84668" y="3.84668" width="16.3066" height="16.3066" rx="2.5" stroke="white" stroke-linecap="round"/>
<path id="Polygon 1" d="M11.2929 6.29676C11.6834 5.90623 12.3166 5.90624 12.7071 6.29676L17.7032 11.2929C18.0938 11.6834 18.0938 12.3166 17.7032 12.7071L12.7071 17.7032C12.3166 18.0938 11.6834 18.0938 11.2929 17.7032L6.29676 12.7071C5.90623 12.3166 5.90624 11.6834 6.29676 11.2929L11.2929 6.29676Z" fill="white"/>
</g>
</g>
</svg>
`;

const checkIcon = `<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="check">
<g id="Group 6">
...
// Function to get appropriate icon for variable type
const getVariableTypeIcon = (type) => {
  ...
  switch (normalizedType) {
    ...
    case 'other':
      return otherIcon;
    default:
      // Default to other icon for any unknown types
      return otherIcon;
  }
};
...
export const icons = {
  ...
  // Helper function for variable type icons
  getVariableTypeIcon
}; 